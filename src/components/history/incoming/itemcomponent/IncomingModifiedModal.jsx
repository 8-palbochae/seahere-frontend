...
import { modifyIncomingPrice } from "../../../../api/incoming/incomingApi";

const IncomingModifiedModal = ({
	incomingId,
	isOpen,
	onClose,
	onSave,
	...
	const modifyIncoming = useMutation({
		mutationFn: (amount) => modifyIncomingPrice(incomingId, amount),
		onSuccess: () => {
		...
		<div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
			<div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full mx-4">
				...
				<div className="mb-6 p-4 bg-gray-100 border border-gray-300 rounded-lg flex items-center">
					<label
						htmlFor="new-amount"
						className="text-md font-semibold text-gray-600 w-1/3"
					>
						변경 후 금액
					</label>
